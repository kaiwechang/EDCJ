...
TARGETS = speedup_1 speedup_1E speedup_3 postprocess ilp_nocap
BIN_DIR = bin
OUT_DIR = output
...
run_cycle: mkdir
	...
	bin/postprocess		$(OUT_DIR)/tar_spd3.all		$(OUT_DIR)/joins.txt		$(OUT_DIR)	> $(OUT_DIR)/postprocess.log
...
run_pure: mkdir
	...
	bin/postprocess		$(OUT_DIR)/query.all		$(OUT_DIR)/joins.txt		$(OUT_DIR)	> $(OUT_DIR)/postprocess.log
	./misJoin_eval.php	$(TEST_DIR)/answerToAll		$(OUT_DIR)/scaffolds.txt				> $(OUT_DIR)/evaulate.txt
...
run_spd1: mkdir
	...
	bin/postprocess		$(OUT_DIR)/tar_spd1.all		$(OUT_DIR)/joins.txt		$(OUT_DIR)	> $(OUT_DIR)/postprocess.log
	./misJoin_eval.php	$(TEST_DIR)/answerToAll		$(OUT_DIR)/scaffolds.txt				> $(OUT_DIR)/evaulate.txt
